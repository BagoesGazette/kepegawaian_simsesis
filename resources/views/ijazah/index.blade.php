      ...
      <div class="section-body">
          <div class="card">
              <div class="card-header">
                <a href="{{ route("ijazahCreate") }}" class="btn btn-success">Upload Ijazah</a>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="{{ url('ijazah/destroy/'.$j->ijazah) }}" class="btn btn-danger tombol-hapus"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
