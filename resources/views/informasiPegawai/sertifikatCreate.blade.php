    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="/informasiPegawai/sertifikat">Sertifikat</a></div>
          ...
          <div class="row">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                  <div class="card">
                      ...
                      <div class="card-body">
                        <form action="{{ route("adminSertifikatStore") }}" method="post" enctype="multipart/form-data">@csrf
                            ...
                            <a href="/informasiPegawai/sertifikat" class="btn btn-warning">Kembali</a>
