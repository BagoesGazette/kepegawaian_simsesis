    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="/informasiKetenagaan">Informasi Ketenagaan</a></div>
      ...
      <div class="section-body">
        <div class="row mt-sm-4">
          ...
          <div class="col-12 col-md-12 col-lg-5">
            <form action="{{ route('tambahInformasi') }}" method="POST" enctype="multipart/form-data" autocomplete="off">@csrf
